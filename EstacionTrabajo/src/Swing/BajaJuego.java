 ...
 * BajaJuego.java
 *
 * Created on Oct 9, 2012, 7:42:58 PM
 */
 ...
 * @author tprog129
 */
public class BajaJuego extends javax.swing.JInternalFrame {
    ...
    private void TablaCatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaCatMouseClicked
        ...
        ListaDataJuego l = icj.listarJuegosPorCategoria(Cat);
    ...
    private void TablaJuegosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaJuegosMouseClicked
        ...
        int confirmado = JOptionPane.showConfirmDialog(null, "¿Confirmar baja del juego " + data.getNombre() + " ?", "CONFIRMAR BAJA", 2);

                if (JOptionPane.OK_OPTION == confirmado){
                    icj.bajaJuego(data.getNombre());
                    JOptionPane.showMessageDialog(null, "Se ha dado de baja con exito");
                    this.dispose();
                }else{
                    icj.terminar();
                    this.dispose();

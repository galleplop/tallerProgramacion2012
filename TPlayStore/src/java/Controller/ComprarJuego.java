...
public class ComprarJuego extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String ide = (String)request.getParameter("idJ");
            int id = Integer.parseInt(ide);
            DataInfoJuego dij = iweb.seleccionarJuegoPorID(id);
            
            
            request.setAttribute("nomJuego", dij.getNombre());
            request.setAttribute("precio", dij.getPrecio());
            request.setAttribute("desarrollador",dij.getNickDesarrollador());
            request.setAttribute("tamano", dij.getTamanio());
            request.setAttribute("idJuego", dij.getId());
            
            request.setAttribute("version", dij.getNumUltimaVersion());
            
            request.getRequestDispatcher("/ComprarJuego.jsp").forward(request, response);

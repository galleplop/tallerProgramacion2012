...
public class ConfiguracionDeNotificaciones extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String vanDatos = (String) request.getParameter("VanDatos");
            if(vanDatos!=null){
                ...
                iweb.cambiarConfiguracionUsuario(nickMail, aa, bb, cc);
                request.getRequestDispatcher("/Home").forward(request, response);
            }else{
                request.getRequestDispatcher("/ConfiguracionDeNotificaciones.jsp").forward(request, response);

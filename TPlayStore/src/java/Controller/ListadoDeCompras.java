    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           if (nomCliente.equals("")){
            ...
            ListaDataJuego lst =  iweb.listarJuegosCliente(nomCliente);
            List<DataJuego> lstGames = lst.getLista();



            request.setAttribute("JuegosCliente", lstGames);

            request.getRequestDispatcher("/ListadoDeCompras.jsp").forward(request, response);
            }
        } finally { 
            out.close();
        }

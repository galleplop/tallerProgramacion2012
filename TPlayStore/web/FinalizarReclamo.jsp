                    ...
                    <tbody align="center" >
                        <tr>
                            ...
                            <td>
                                ...
                                <h1 align="center" style="color: #8c83ff"> ¡Su reclamo ha sido ingresado con &eacute;xito!</h1>

                                <img alt=""  src="images/mensajes/exito.jpg" width="300"/> <br>

                                <input align="right" type="image" height="50px" src="images/mensajes/ok.png" onclick="parent.location='/Home'">

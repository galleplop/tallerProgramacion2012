                    ...
                    <tbody align="center" >
                        <tr>
                            ...
                            <td>
                                ...
                                <h1 align="center" style="color: #8c83ff"> ¡Se ha completado la compra con &eacute;xito!</h1>
                                
                                <img alt=""  src="images/mensajes/exito.jpg" width="300"/> <br>
                                ...
                                <%
                                    ...
                                    int nombreJuego = dij.getId();
                                %>
                                <p align="center" style="color: #8c83ff">Para iniciar la descarga haz clic <a href="/Descarga?tipo=Jar&idJ=<%= nombreJuego%>">aquí</a>.</p>
                            </td>
                        </tr>
                    </tbody>
